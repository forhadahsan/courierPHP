        ...
        <div class="container"><a class="navbar-brand" href="index.php"><img src="assets/img/gallery/logo.png" height="45" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              ...
              <li class="nav-item px-2"><a class="nav-link" href="branch.php">Branch</a></li>
              <li class="nav-item px-2"><a class="nav-link" href="registion.php">Registion</a></li>
              <li class="nav-item px-2"><a class="nav-link" href="#findUs">Find Us</a></li>
              <li class="nav-item px-2"><a class="nav-link" href="contactus.php">Contact Us</a></li>
            ...
            </div><a class="btn btn-primary order-1 order-lg-0 ms-lg-3" href="login.php">Log in</a>
