...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
        ...
        <div class="row">
          <div class="col-md-6">
              <b style="font-size: 25px;">Sender Information</b>
          ...
          <div class="col-md-6">
              <b style="font-size: 25px;">Recipient Information</b>
              <div class="form-group">
                <label for="" class="control-label">Name</label>
        ...
        <table class="table table-bordered" id="parcel-items">
          ...
          <tbody>
            <tr>
              ...
              <td><input type="text" name='width[]' value="<?php echo isset($width) ? $wid = $width - $length :'' ?>" required></td>
