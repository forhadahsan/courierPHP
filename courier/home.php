...
<?php if($_SESSION['login_type'] == 1): ?>
        <div class="row">
          ...
          <hr>
          <?php 
              $status_arr = array("Item Accepted by Courier","Collected","Shipped","In-Transit","Arrived At Destination","Out for Delivery","Ready to Pickup","Delivered","Picked-up","Unsuccessfull Delivery Attempt","Delivery Charge","Total Amout");
